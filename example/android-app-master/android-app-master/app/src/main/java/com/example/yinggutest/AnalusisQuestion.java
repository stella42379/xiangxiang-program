...
import com.example.yinggutest.mianpage.fragment.everypractice.adapter.AnalusisQuestionAdapter;
...
public class AnalusisQuestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analusis_question);
        findViews();
        initData();
        initEvent();
    }
    ...
    private void findViews() {
        vpAnalysis = findViewById(R.id.vp_activity_analysis_question);
        ivBlack = findViewById(R.id.iv_black_analusis_question);
        initViewPagerScroll();
    }
    ...
    private void initData() {
        ...
        AnalusisQuestionAdapter examinationSubmitAdapter =
                new AnalusisQuestionAdapter(AnalusisQuestion.this,viewItems,SaveQuestionData.sSaveQuestionList,imgServerUrl);
